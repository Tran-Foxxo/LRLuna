        ...
        private void Setup()
        {
            switch (_linetype)
            {
                case LineType.Blue:
                    ...
                    {
                        _color = Constants.BlueLineColored;
                    }
                    else _color = Constants.BlueLineColor;
                    break;
                case LineType.Red:
                    if (Settings.AccelerationColorChange)
                    {
                        _color = Constants.RedLineColored;
                    }
                    else _color = Constants.RedLineColor;
                    break;
                case LineType.Scenery:
                    if (Settings.SceneryColorChange)
                    {
                        _color = Constants.SceneryLineColored;
                    }
                    else _color = Constants.SceneryLineColor;
                    break;
            }
