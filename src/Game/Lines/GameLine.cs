        ...
        public Color GetColor()
        {
            ...
            switch (Type)
            {
                case LineType.Blue:
                    ...
                    else return Constants.BlueLineColor;
                case LineType.Red:
                    if (Settings.AccelerationColorChange)
                    {
                        return Constants.RedLineColored;
                    }
                    else return Constants.RedLineColor;
                case LineType.Scenery:
                    if (Settings.SceneryColorChange)
                    {
                        return Constants.SceneryLineColored;
                    }
                    else return Constants.SceneryLineColor;
                default:
